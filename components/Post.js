...
function Post({ id, post, postPage }) {
  ...
  return (
    <div className="p-3 flex cursor-pointer border-b border-x-twitterColor1" onClick={() => router.push(`/${id}`)}>
      {!postPage && (
        <img 
          src={post?.userImg} 
          alt="user image" 
      ...
      <div className="flex flex-col space-y-2 w-full">
        <div className={`flex ${!postPage && "justify-between"}`}>
          ...
          <div className="text-slate-500">
            <div className="inline-block group">
              <h4 className={`font-bold text-[15px] sm:text-base text-twitterColor1 group-hover:underline ${
            ...
            {!postPage && (
              <p className="text-twitterColor1 text-[15px] sm:text-base mt-0.5">{post?.text}</p>
            )}
          </div>
        ...
        <div className={`text-slate-500 flex justify-between w-10/12 ${postPage && "mx-auto"}`}>
          <div
            ...
            >
              <div className="icon group-hover:bg-[#1d9bf0] group-hover:bg-opacity-10">
                <ChatOutlinedIcon className="h-5 group-hover:text-[#1d9bf0]" />
              </div>
              {comments.length > 0 && (
          ...
          {session.user.uid === post?.id ? (
            ...
            >
              <div className="icon group-hover:bg-red-600/10">
                <DeleteForeverOutlinedIcon className="h-5 group-hover:text-red-600" />
              </div>
            </div>
          ) : (
          ...
          <div className="icon group">
            <ShareOutlinedIcon className="h-5 group-hover:text-[#1d9bf0]" />
          </div>
